<h3 class="page-header"><i class="fa fa-folder-o"></i> Добавление субкатегории</h3>
<hr>

<div class="wrapper">

{!! Form::open(['url' => route('subbrandsAdd', $brand_id),'class'=>'form-horizontal','method'=>'POST','enctype'=>'multipart/form-data']) !!}
{!! Form::hidden('redirects_to', URL::previous()) !!}
	...
	<div class="form-group">
        ...
        <div class="col-sm-8">
            ...
            <small class="help-block">К какой категории товаров будет относиться субкатегория.</small>
        </div>
    </div>
	<div class="form-group">
