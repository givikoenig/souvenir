<h3 class="page-header"><i class="fa fa-bookmark-o"></i> Добавление категории товаров</h3>
<hr>

<div class="wrapper">

{!! Form::open(['url' => route('brandsAdd'),'class'=>'form-horizontal','method'=>'POST']) !!}
	
	<div class="form-group">
		{!! Form::label('name','Название категории :',['class'=>'col-xs-2 control-label']) !!}  
		<div class="col-sm-8">
			{!! Form::text('name',old('alias') ,['class'=>'form-control','placeholder'=>'Введите название …']) !!}
		</div>
		<br /><br />
	</div>
	<div class="form-group">
