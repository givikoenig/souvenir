                                             ...
                                             <td>
                                                ...
                                                <table width="160" align="left" border="0" cellpadding="0" cellspacing="0" class="col3img">
                                                   <tbody>
                                                      ...
                                                      <tr>
                                                         <td align="center">
                                                            <img src="{{ asset('/emails/img/6.jpg')}}" alt="" border="0" width="160" height="160" style="display:block; border:none; outline:none; text-decoration:none;" class="col3img">
                                                         </td>
                                                      </tr>
                                                      <!-- end of image2 -->
                                                   </tbody>
                                                ...
                                                <table width="160" align="left" border="0" cellpadding="0" cellspacing="0" class="col3img">
                                                   <tbody>
                                                      ...
                                                      <tr>
                                                         <td align="center">
                                                            <img src="{{ asset('/emails/img/15.jpg') }}" alt="" border="0" width="160" height="160" style="display:block; border:none; outline:none; text-decoration:none;" class="col3img">
                                                         </td>
                                                      </tr>
                                                      <!-- end of image2 -->
                                                   </tbody>
                                                ...
                                                <table width="160" align="right" border="0" cellpadding="0" cellspacing="0" class="col3img">
                                                   <tbody>
                                                      ...
                                                      <tr>
                                                         <td align="center">
                                                            <img src="{{ asset('/emails/img/17.jpg') }}" alt="" width="160" height="160" border="0" style="display:block; border:none; outline:none; text-decoration:none;" class="col3img">
                                                         </td>
                                                      </tr>
                                                      <!-- end of image3 -->
                                                   </tbody>
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #7a6e67; text-align:left; line-height: 24px;">
                                                <p>
                                                Ваш Email был указан при заказе товаров из нашего <a href="{{route('home')}}" target="_blank"> Интернет магазина</a>. Если Вы ничего не заказывали, то игнорируйте это письмо. 
                                                </p>
                                       ...
                                       <tbody>
                                          <tr>
                                             <td>
                                                ...
                                                <table width="520" border="0" cellpadding="0" cellspacing="0" class="devicewidthmob">
                                                   <tbody>
                                                      <tr>
                                                      ...
                                                      <tr>
                                                         <td width="250" align="center" class="devicewidth">
                                                            <img src="{{ asset('/emails/img/login1.jpg') }}" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" class="col2img">
                                                         </td>
                                                         <td width="250" align="center" class="devicewidth">
                                                            <img src="{{ asset('/emails/img/login2.jpg') }}" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" class="col2img">
                                                         </td>
                                                      </tr>
                                                      ...
                                                      <tr>
                                                         <td  colspan="2" style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #7a6e67; text-align:left; line-height: 24px;" class="padding-right15">
                                                            3. Теперь Вы можете зайти в свой <a href="{{ route('home') }}/profile" target="_blank"> личный кабинет </a>.
                                                         </td>
                                                      </tr>
                                          ...
                                          <tr>
                                             <td width="22" height="22" align="left">
                                                <div class="imgpop">
                                                   ...
                                                   <img src="{{ asset('/emails/img/facebook.png') }}" alt="" border="0" width="22" height="22" style="display:block; border:none; outline:none; text-decoration:none;">
                                                   </a>
                                                </div>
                                             </td>
                                             ...
                                             <td width="22" height="22" align="right">
                                                <div class="imgpop">
                                                   <a href="javascript:void(0)">
                                                   <img src="{{ asset('/emails/img/twitter.png') }}" alt="" border="0" width="22" height="22" style="display:block; border:none; outline:none; text-decoration:none;">
                                                   </a>
                                                </div>
                                             </td>
