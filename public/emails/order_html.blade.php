...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <meta charset="UTF-8">
      <title>Подтверждение регистрации в Интернет-магазине</title>
      <style type="text/css">
         ...
         a {color: #ff7f00;text-decoration: none;text-decoration:none!important;}
         /*STYLES*/
                                 ...
                                 <td>
                                    ...
                                    <table width="194" align="left" border="0" cellpadding="0" cellspacing="0">
                                       <tbody>
                                          <tr>
                                             <td width="20"></td>
                                             <td width="174" height="60" align="center">
                                                <div class="imgpop" style="background-color: #eeeeee; padding: 3px;">
                                                   <a target="_blank" href="http://souvenir.loc">
                                                   <img src="img/logo.png" alt="" border="0" width="114"  style="display:block; border:none; outline:none; text-decoration:none;">
                                                   </a>
                                                </div>
                                             </td>
                                          </tr>
                                             ...
                                             <td>
                                                ...
                                                <table width="160" align="left" border="0" cellpadding="0" cellspacing="0" class="col3img">
                                                   <tbody>
                                                      ...
                                                      <tr>
                                                         <td align="center">
                                                            <img src="img/6.jpg" alt="" border="0" width="160" height="160" style="display:block; border:none; outline:none; text-decoration:none;" class="col3img">
                                                         </td>
                                                      </tr>
                                                      <!-- end of image2 -->
                                                   </tbody>
                                                ...
                                                <table width="160" align="left" border="0" cellpadding="0" cellspacing="0" class="col3img">
                                                   <tbody>
                                                      ...
                                                      <tr>
                                                         <td align="center">
                                                            <img src="img/15.jpg" alt="" border="0" width="160" height="160" style="display:block; border:none; outline:none; text-decoration:none;" class="col3img">
                                                         </td>
                                                      </tr>
                                                      <!-- end of image2 -->
                                                   </tbody>
                                                ...
                                                <table width="160" align="right" border="0" cellpadding="0" cellspacing="0" class="col3img">
                                                   <tbody>
                                                      ...
                                                      <tr>
                                                         <td align="center">
                                                            <img src="img/17.jpg" alt="" width="160" height="160" border="0" style="display:block; border:none; outline:none; text-decoration:none;" class="col3img">
                                                         </td>
                                                      </tr>
                                                      <!-- end of image3 -->
                                                   </tbody>
                                       ...
                                       <tbody>
                                          <tr>
                                             <td>
                                                   ...
                                                   <tbody>
                                                      ...
                                                      <tr>
                                                         <td width="200" height="150" align="center" class="devicewidth">
                                                            <img src="img/logo.png" alt="" border="0" width="114" height="32" style="display:block; border:none; outline:none; text-decoration:none;" class="col2img">
                                                         </td>
                                                      </tr>
                                                      <!-- /image -->
                                                   </tbody>
                                                ...
                                                <table align="right" border="0" cellpadding="0" cellspacing="0" class="mobilespacing">
                                                   <tbody>
                                                      <tr>
                                                         <td width="100%" height="15" style="font-size:1px; line-height:1px; mso-line-height-rule: exactly;">&nbsp;</td>
                                                      </tr>
                                                ...
                                                <table width="300" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidthmob">
                                                   <tbody>
                                                      <tr>
                                                      ...
                                                      <tr>
                                                         <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #7a6e67; text-align:left; line-height: 24px;" class="padding-right15">
                                                            Ваш Email был указан при заказе товаров из нашего <a target="_blank" href="http://souvenir.loc">Интернет магазина</a>.
															               Если Вы ничего не заказывали, то игнорируйте это письмо.
                                                         </td>
                                                      </tr>
                                                      <!-- end of content -->
                                                   </tbody>
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #7a6e67; text-align:left; line-height: 24px;">
                                                <p>
                                                Просмотреть детали Ваших заказов, а также изменить пароль для регистрации на сайте, nickname (псевдоним) для участия в обсуждениях статей <a href="http://souvenir.loc/blog">блога</a> , загрузить свой аватар, Вы можете  после <a href="{{ route('confirmation', $data['token']) }}">активации </a> Вашей учетной записи в  <a target="_blank" href="{{ route('profile') }}">личном кабинете</a>.
                                                </p>
                                       ...
                                       <tbody>
                                          <tr>
                                             <td>
                                                ...
                                                <!-- start of right column -->
                                                <table width="520" {{-- align="right" --}} border="0" cellpadding="0" cellspacing="0" class="devicewidthmob">
                                                   <tbody>
                                                      <tr>
                                                         <td colspan="2" style="font-family: Helvetica, arial, sans-serif; font-size: 18px; color: #2d2a26; text-align:left; line-height: 24px;" class="padding-top-right15">
                                                            Ваши действия :
                                                         </td>
                                                      </tr>
                                                      <!-- end of title -->
                                                      <!-- Spacing -->
                                                      <tr>
                                                         <td  colspan="2" width="100%" height="15" style="font-size:1px; line-height:1px; mso-line-height-rule: exactly;">&nbsp;</td>
                                                      </tr>
                                                      <!-- /Spacing -->
                                                      <!-- content -->
                                                      <tr>
                                                         <td colspan="2" style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #7a6e67; text-align:left; line-height: 24px;" class="padding-right15">
                                                            1.  <a href="{{ route('confirmation', $data['token']) }}">Активируйте </a> Вашу учетную запись
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td  colspan="2" style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #7a6e67; text-align:left; line-height: 24px;" class="padding-right15">
                                                            2. Войдите на сайт <a href="{{ route('home') }}/login" target="_blank"> здесь </a> или с сайта, как указано на рисунках ниже:
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td width="250" align="center" class="devicewidth">
                                                            <img src="img/login1.jpg" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" class="col2img">
                                                         </td>
                                                         <td width="250" align="center" class="devicewidth">
                                                            <img src="img/login2.jpg" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" class="col2img">
                                                         </td>
                                                      </tr>
                                                      
                                                      <tr>
                                                         <td colspan="2" style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #7a6e67; text-align:left; line-height: 24px;" class="padding-right15">
                                                            Ваши текущие данные для входа:
                                                            <br>
                                                            Логин: {{ $data['email'] }}
                                                            <br>
                                                            Пароль: {{ $data['pwd'] }}
                                                            <br><br>
                                                            Ваш текущий nickname: {{ $data['nick'] }} 
                                                         </td>
                                                      </tr>
